                            ...
                            <div class="card-body">
                                <form action="{{ url('update-category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $category->name }}" type="text" id="example-text-input"
                                                name="name">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $category->slug }}" type="text" id="example-search-input"
                                                name="slug">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-1">
                                            <input class="form-check-input" type="checkbox" {{ $category->status == "1" ? 'checked' : '' }} id="formCheck1" name="status">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-1">
                                            <input class="form-check-input" type="checkbox" {{ $category->popular == "1" ? 'checked' : '' }} id="example-tel-input"
                                                name="popular">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        <label for="example-password-input" class="col-sm-2 col-form-label">Meta
                                            Title</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $category->meta_title }}" type="text" id="example-password-input"
                                                name="meta_title">
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        <label for="example-number-input" class="col-sm-2 col-form-label">Meta
                                            Keywords</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="meta_keywords" rows="5">{{ $category->meta_keywords }}</textarea>
                                        </div>
                                    </div>
                                    <!-- end row -->
                                    <div class="row mb-3">
                                        <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Meta
                                            Description</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="meta_description" rows="5">{{ $category->meta_descrip }}</textarea>
                                        </div>
                                    </div>
